...
{
    TileType type;
    std::vector<int> adjacencyList; // List of adjacent tile indices
};
...
int main()
{
    ...
    InitWindow(screenWidth, screenHeight, "Tilemap Game");
    ...
    Vector2 characterPosition{ 1, 1 }; // Starting position of the character

    SetTargetFPS(10); // Set the frame rate to 60 FPS
    ...
    while (!WindowShouldClose())
    {
        ...
        // Update character position if it has changed
